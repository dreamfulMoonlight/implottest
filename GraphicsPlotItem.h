 ...
 */
class GraphicsPlotItem : public QGraphicsItem
{
public:
    ...
    inline void setAbscissaRange(double min, double max)
    {
        setAxisRange(0, min, max);
    }
    inline void setOrdinateRange(double min, double max)
    {
        setAxisRange(1, min, max);
    }
