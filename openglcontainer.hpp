...
class OpenGLContainer : public QOpenGLWidget, protected QOpenGLFunctions
{
    Q_OBJECT
...
private:
    ...
    void initializeGL();
    /**
     * @brief paintGL triggered when redrawing is required (updageGL() or update(); for example: resizing, hiding etc.
     * the widget)
     */
    void paintGL();
    /**
     ...
     * @param event gives information about the mouse movement (used for the translation along the X and Y axes and
     * rotation around all three axes)
     */
    void mouseMoveEvent(QMouseEvent *event);
    /**
     * @brief wheelEvent handles the scrolling of the mouse wheel
     * @param event gives information about the rotation of the mouse wheel (used for the translation along the X and Y
     * axes and rotation around all three axes)
     */
...
public slots:
    ...
    void zoomIn();
    /**
     * @brief zoomOut translates the camera long the Z axis outward the scene (same as scrolling down with the mouse
     * wheel)
     */
    void zoomOut();
    /**
